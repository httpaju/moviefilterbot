...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.imgur.com/HbniajR.jpeg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+DIHUx2-YVbpmNGU1')
...
MSG_ALRT = environ.get('MSG_ALRT', 'hi')
